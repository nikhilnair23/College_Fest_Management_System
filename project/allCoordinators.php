...
<div class="box">
<?php 
$sql_for_participants = "select volunteer.usn, volunteer.name, volunteer.email, volunteer.phno, event.ename from volunteer inner join event on event.C_USN = volunteer.usn";
$result_part = mysql_query($sql_for_participants);
$table = "<table class='table'><tr><th>USN</th><th>Name</th><th>Contact</th><th>Email</th><th>Ename</th>";
